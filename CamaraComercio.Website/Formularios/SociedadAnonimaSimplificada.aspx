<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/res/noboxForm.Master" CodeBehind="SociedadAnonimaSimplificada.aspx.cs" Inherits="CamaraComercio.Website.Formularios.SociedadAnonimaSimplificada" %>
                        ...
                        <fieldset class="form-fieldset">
                            ...
                            <div id="sociedadData" class="RadGrid RadGrid_NoboxGrid">
                                ...
                                <ul style="padding-left: 5px; padding-top: 5px">
                                    ...
                                    <li>
                                        <asp:Label ID="lbDesc" Text="DESCRIPCIÓN DEL NEGOCIO: " AssociatedControlID="txtDesc" runat="server"></asp:Label>
                                        &nbsp;
                                    ...
                                    <li>
                                        <br />
                                        <h5 style="align-content: center; height: 5px; color:black">CAPITAL SOCIAL AUTORIZADO</h5>
                                        <br />
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <asp:Label ID="lbMonenda" Text="TIPO: " AssociatedControlID="txtMoneda" runat="server"></asp:Label>
                                        &nbsp;
                                    ...
                                    <li>
                                        <br />
                                        <h5 style="align-content: center; height: 5px; color:black">CAPITAL SUSCRITO Y PAGADO</h5>
                                        <br />
                                    </li>
                                    <li>
                                        <asp:Label ID="lbMontoCSP" Text="MONTO: " AssociatedControlID="txtMontoCSP" runat="server"></asp:Label>
                                        &nbsp;
                                        <asp:Label ID="txtMontoCSP" Text="" runat="server" CssClass="tb over" Width="70%" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        <asp:Label ID="lbMonedaCSP" Text="TIPO MONEDA: " AssociatedControlID="txtMonedaCSP" runat="server"></asp:Label>
                                        &nbsp;
                                        <asp:Label ID="txtMonedaCSP" Text="" runat="server" CssClass="tb" Height="16px" Width="103px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
