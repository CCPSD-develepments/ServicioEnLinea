<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/res/noboxForm.Master" CodeBehind="SociedadCSimple.aspx.cs" Inherits="CamaraComercio.Website.Formularios.SociedadCSimple" %>
                        ...
                        <fieldset class="form-fieldset">
                            ...
                            <div id="sociedadData" class="RadGrid RadGrid_NoboxGrid">
                                ...
                                <ul style="padding-left: 5px; padding-top: 5px">
                                    ...
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtTipoSocietario" Text="" runat="server" style="text-transform: uppercase;" CssClass="tb over" Width="70%" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                    ...
                                    <%--<li>
                                        <asp:Label ID="lnDuracionDirectiva" runat="server" AssociatedControlID="txtDuracionDirectiva" Text="Cantidad de años: " Height="16px" Width="212px"></asp:Label>
                                        &nbsp;
                                        <asp:Label ID="txtDuracionDirectiva" runat="server" Text=""></asp:Label>
                                        <br />
                                        <br />
                                    </li>--%>
                                    <li>
                            ...
                            <div id="Socios">
                                ...
                                <div id="OrganoGestor" class="RadGrid RadGrid_NoboxGrid">
                                    <%--  --%>
                                    <div id="ComanditadoDiv" runat="server">
                                    ...
                                    <%--  --%>
                                    <%--  --%>
                                    <div id="ComanditarioDiv" runat="server">
                                    ...
                                    <%--  --%>
                                    <%--  --%>
                                    <div id="ComisarioDiv" runat="server">
                                ...
                                <%--<div id="entesRegTbl" runat="server" class="RadGrid RadGrid_NoboxGrid">
                                    <h4 style="align-content: center; height: 2px;" align="center">&nbsp;CONSEJO DE VIGILANCIA</h4>
                                    <br />
