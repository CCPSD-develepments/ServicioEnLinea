<%@ Page Title="" Language="C#" MasterPageFile="~/res/nobox.master" AutoEventWireup="true"
    CodeBehind="Confirmacion.aspx.cs" Inherits="CamaraComercio.Website.Operaciones.Registro.Confirmacion" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btnConfirmarDatos').click(function (e) {
                ...
                $("#dialog-content").text("Una vez confirmados estos datos, no podrán ser modificados. Recuerda que los datos suministrados " 
                    + "aparecerán en el certificado tal y como fueron digitados");
    ...
    <div class="container_24">
        <div class="grid_24">
            <div id="content_header">
                <h1 id="creacion">
                    Creación de Empresas <span class="right normal">
            ...
            <div id="content_body">
                ...
                <div id="confirmacionDiv">
                    ...
                    <h5>
                        Verifica la información de la registración de la empresa. Si no estás satisfecho
                        con algún campo, puedes hacer click en el botón de "Modificar. Si verificaste la
                        información y confirmaste que es correcta, haz click en "Confirmar". <strong>Nota Importante:
                            Una vez confirmados estos datos, no podrán ser modificados. </strong>
                    </h5>
