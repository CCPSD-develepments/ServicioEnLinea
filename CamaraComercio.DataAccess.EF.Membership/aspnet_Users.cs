    ...
    public static string LastActivityDate = @"LastActivityDate";
        ...
        public virtual ICollection<ActivityLog> ActivityLog
        {
            get
            {
                ...
                {
                    var newCollection = new FixupCollection<ActivityLog>();
                    newCollection.CollectionChanged += FixupActivityLog;
                    _activityLog = newCollection;
                }
                return _activityLog;
            }
            set
            {
                ...
                {
                    var previousValue = _activityLog as FixupCollection<ActivityLog>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupActivityLog;
                    }
                    _activityLog = value;
                    var newValue = value as FixupCollection<ActivityLog>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupActivityLog;
                    }
                }
            }
        }
