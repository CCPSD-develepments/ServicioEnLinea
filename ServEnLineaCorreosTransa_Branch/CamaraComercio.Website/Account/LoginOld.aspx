<%@ Page Title="Log In" Language="C#" MasterPageFile="~/res/Consulta_header.master" AutoEventWireup="true"
    CodeBehind="LoginOld.aspx.cs" Inherits="CamaraComercio.Website.Account.Login" %>
                    ...
                    <div class="loginbox floatRight">
                        ...
                        <fieldset class="login-fieldset">
                            ...
                            <p class="rememberme">
                                    <asp:CheckBox ID="RememberMe" runat="server" ClientIDMode="Static" />
                                    <label for="RememberMe">
                                        Represento una oficina  <br />de abogados o dep. legal corporativo</label>
                                </p>
