...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'ModificacionPage.PersonasRegistro'
        ...
        //2021-08-21:
        private SRM.CamaraSRMEntities _srmDbContext;
        public SRM.CamaraSRMEntities SrmDbContext
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'ActualizarDatosGenerales.SrmDbContext'
        {
            get
            {
                if (_srmDbContext == null) _srmDbContext = new SRM.CamaraSRMEntities(DataAccess.EF.Helpers.GetCamaraConnString(CamaraId));
...
#pragma warning restore CS0618 // 'ModificacionPage.InstanceXML' is obsolete: 'Metodo no utilizado, ya no se envia el XML'
        ...
        {
            //2021-08-30: para uactualizacion de datos:
            ...
            using (var tnx = repTransacciones.BeginTransaction())
            {
                try
                {
                    ...
                    //2021-08-30, actualizacion:
                    this.TransaccionesEnRegistroFinal.CorreoContacto = _CorreoContacto;
                    this.TransaccionesEnRegistroFinal.CorreoEmpresa = (registroSRM != null) ? registroSRM.Direcciones.Email : "";
