...
namespace CamaraComercio.DataAccess.EF.OficinaVirtual
{
    ...
    public partial class FormasPagos
    {
    	...
    	public static string NotaFacturaId = @"NotaFacturaId";	
    	public static string FormaPagoDesc = @"FormaPagoDesc";	
        ...
        public virtual Nullable<int> NotaFacturaId
        {
            get;
            set;
        }
    
        public virtual string FormaPagoDesc
        {
            get;
            set;
        }
