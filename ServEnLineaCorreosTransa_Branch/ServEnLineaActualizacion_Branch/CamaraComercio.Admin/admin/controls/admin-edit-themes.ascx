<%@ Control Language="C#" AutoEventWireup="true" Inherits="admin_controls_admin_edit_themes" Codebehind="admin-edit-themes.ascx.cs" %>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetAdminThemes" TypeName="site_ThemesTableAdapter" UpdateMethod="Update" OnSelected="ObjectDataSource1_Selected">
  <DeleteParameters>
