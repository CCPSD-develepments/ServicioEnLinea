<%@ Control Language="C#" AutoEventWireup="true" Inherits="admin_controls_users_online" Codebehind="users-online.ascx.cs" %>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" DataSourceID="ObjectDataSource1" AutoGenerateColumns="False" DataKeyNames="userName" EmptyDataText="No se encontraron registros." OnDataBound="GridView1_DataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDataBound="GridView1_RowDataBound" CssClass="gv">
    ...
    <Columns>
        ...
        <asp:BoundField DataField="creationdate" HeaderText="Creada En" SortExpression="creationdate" />
        ...
        <asp:CheckBoxField DataField="IsOnline" HeaderText="En Línea" SortExpression="IsOnline">
            <ItemStyle HorizontalAlign="Center" />
        </asp:CheckBoxField>
