...
{
    public partial class vw_aspnet_ProfilesProperties
    {
    ...
    public static string IpFirma = @"IpFirma";
        ...
        public virtual string ContratoFirmado
        {
            get;
            set;
        }
    
        public virtual string IpFirma
        {
            get;
            set;
        }
