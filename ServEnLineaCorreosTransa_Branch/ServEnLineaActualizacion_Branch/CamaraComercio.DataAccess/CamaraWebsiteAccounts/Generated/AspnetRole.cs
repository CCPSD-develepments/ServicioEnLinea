...
namespace CamaraComercio.DataAccess.CamaraWebsiteAccounts
{
	...
	public partial class AspnetRole : ActiveRecord<AspnetRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Roles", TableType.Table, DataService.GetInstance("WebsiteAccountsProvider"));
				...
				DataService.Providers["WebsiteAccountsProvider"].AddSchema("aspnet_Roles",schema);
			}
		}
		#endregion
		...
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.RoleId, RoleId).Load();
		}
		#endregion
		...
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetUserCollection GetAspnetUserCollection() { return AspnetRole.GetAspnetUserCollection(this.RoleId); }
		public static CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetUserCollection GetAspnetUserCollection(Guid varRoleId)
		{
