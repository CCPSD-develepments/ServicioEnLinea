...
namespace CamaraComercio.DataAccess.CamaraWebsiteAccounts
{
	...
	public partial class AspnetPersonalizationPerUser : ActiveRecord<AspnetPersonalizationPerUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationPerUser", TableType.Table, DataService.GetInstance("WebsiteAccountsProvider"));
				...
				DataService.Providers["WebsiteAccountsProvider"].AddSchema("aspnet_PersonalizationPerUser",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetPath AspnetPath
		{
			get { return CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetPath.FetchByID(this.PathId); }
