...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewTransaccionesList class.
    /// </summary>
    [Serializable]
    public partial class ViewTransaccionesListCollection : ReadOnlyList<ViewTransaccionesList, ViewTransaccionesListCollection>
    {        
        public ViewTransaccionesListCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_TransaccionesList view.
    /// </summary>
    [Serializable]
    public partial class ViewTransaccionesList : ReadOnlyRecord<ViewTransaccionesList>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_TransaccionesList", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_TransaccionesList",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewTransaccionesList()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewTransaccionesList(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewTransaccionesList(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewTransaccionesList(string columnName, object columnValue)
        {
            SetSQLProps();
