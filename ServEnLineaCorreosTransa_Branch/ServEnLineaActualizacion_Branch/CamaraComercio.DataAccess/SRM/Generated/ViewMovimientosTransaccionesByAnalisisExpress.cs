...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewMovimientosTransaccionesByAnalisisExpress class.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByAnalisisExpressCollection : ReadOnlyList<ViewMovimientosTransaccionesByAnalisisExpress, ViewMovimientosTransaccionesByAnalisisExpressCollection>
    {        
        public ViewMovimientosTransaccionesByAnalisisExpressCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_MovimientosTransaccionesByAnalisisExpress view.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByAnalisisExpress : ReadOnlyRecord<ViewMovimientosTransaccionesByAnalisisExpress>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_MovimientosTransaccionesByAnalisisExpress", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_MovimientosTransaccionesByAnalisisExpress",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewMovimientosTransaccionesByAnalisisExpress()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewMovimientosTransaccionesByAnalisisExpress(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewMovimientosTransaccionesByAnalisisExpress(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewMovimientosTransaccionesByAnalisisExpress(string columnName, object columnValue)
        {
            SetSQLProps();
