...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewUltimosMovimientosTransacciones class.
    /// </summary>
    [Serializable]
    public partial class ViewUltimosMovimientosTransaccionesCollection : ReadOnlyList<ViewUltimosMovimientosTransacciones, ViewUltimosMovimientosTransaccionesCollection>
    {        
        public ViewUltimosMovimientosTransaccionesCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_UltimosMovimientosTransacciones view.
    /// </summary>
    [Serializable]
    public partial class ViewUltimosMovimientosTransacciones : ReadOnlyRecord<ViewUltimosMovimientosTransacciones>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_UltimosMovimientosTransacciones", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_UltimosMovimientosTransacciones",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewUltimosMovimientosTransacciones()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewUltimosMovimientosTransacciones(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewUltimosMovimientosTransacciones(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewUltimosMovimientosTransacciones(string columnName, object columnValue)
        {
            SetSQLProps();
