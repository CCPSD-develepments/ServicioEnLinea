...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewEtiquetasDocumentos class.
    /// </summary>
    [Serializable]
    public partial class ViewEtiquetasDocumentosCollection : ReadOnlyList<ViewEtiquetasDocumentos, ViewEtiquetasDocumentosCollection>
    {        
        public ViewEtiquetasDocumentosCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_EtiquetasDocumentos view.
    /// </summary>
    [Serializable]
    public partial class ViewEtiquetasDocumentos : ReadOnlyRecord<ViewEtiquetasDocumentos>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_EtiquetasDocumentos", TableType.View, DataService.GetInstance("SrmProvider"));
                schema.Columns = new TableSchema.TableColumnCollection();
                schema.SchemaName = @"Consulta";
                //columns
                ...
                colvarTransSufijo.IsNullable = false;
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_EtiquetasDocumentos",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewEtiquetasDocumentos()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewEtiquetasDocumentos(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewEtiquetasDocumentos(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewEtiquetasDocumentos(string columnName, object columnValue)
        {
            SetSQLProps();
