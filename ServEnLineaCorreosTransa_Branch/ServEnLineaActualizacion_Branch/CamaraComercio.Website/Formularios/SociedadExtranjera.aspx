<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/res/noboxForm.Master" CodeBehind="SociedadExtranjera.aspx.cs" Inherits="CamaraComercio.Website.Formularios.SociedadExtranjera" %>
                    ...
                    <asp:View runat="server" ID="succesfullView">
                        <fieldset class="form-fieldset">
                            ...
                            <div id="servicio" class="RadGrid RadGrid_NoboxGrid" style="padding: 2px">
                                ...
                                &nbsp;
                                <asp:Label ID="txtServicio" runat="server" CssClass="tb over" Width="720px" ReadOnly="True" AssociatedControlID="txtServicio"></asp:Label>
                                <br />
                                <br />
                            </div>
                            ...
                            <div id="gestorData" class="RadGrid RadGrid_NoboxGrid">
                                <ul style="padding-left: 5px; padding-top: 5px">
                                    <%--<li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtSolicitante" Text="" runat="server" ReadOnly="True" CssClass="tb over" Width="250px"></asp:Label>
                                        <br />
                                        <br />
                                    </li>--%>
                                    <%--<li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtRNC1" Text="" runat="server" CssClass="tb over" Width="130px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>--%>
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtNombreCont" Text="" runat="server" ReadOnly="True" CssClass="tb over" Width="200px"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtCedula" Text="" runat="server" CssClass="tb over" Width="130px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtEmail" runat="server" CssClass="tb over" Width="250px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtTelefono" Text="" runat="server" CssClass="tb over" Width="130px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                            ...
                            <div id="sociedadData" class="RadGrid RadGrid_NoboxGrid">
                                ...
                                <ul style="padding-left: 5px; padding-top: 5px">
                                    ...
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtNoRegistro" Text="" runat="server" CssClass="tb over" Width="103px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtRNCSoc" Text="" runat="server" CssClass="tb over" Width="103px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtFechaEmision" Text="" runat="server" CssClass="tb over" Width="130px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtFechaVenc" Text="" runat="server" CssClass="tb over" Width="103px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtFechaConst" Text="" runat="server" CssClass="tb over" Width="130px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtEstadoSociedad" Text="" runat="server" CssClass="tb over" Width="103px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtTel1" Text="" runat="server" CssClass="tb over" Width="130px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtTel2" Text="" runat="server" CssClass="tb over" Width="130px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtPagWeb" Text="" runat="server" CssClass="tb over" Width="280px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtNacionalidad" Text="" runat="server" CssClass="tb over" Width="280px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtRegitroNComercial" Text="" runat="server" CssClass="tb over" Width="103px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    ...
                                    <li>
                                        <br />
                                        <h5 style="align-content: center; height: 5px; color:black">CAPITAL SOCIAL/SOCIAL AUTORIZADO</h5>
                                        <br />
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <br />
                                        <h5 style="align-content: center; height: 5px; color:black">CAPITAL PAGADO/ASIGNADO</h5>
                                        <br />
                                    </li>
                                    <li>
                                        <asp:Label ID="lblCapitalPagado" Text="MONTO: " AssociatedControlID="txtMonto" runat="server"></asp:Label>
                                        &nbsp;
                                        <asp:Label ID="txtCapitalPagado" Text="" runat="server" CssClass="tb over" Width="70%" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                                        <asp:Label ID="lblCapitalPagadoTipoMoneda" Text="TIPO MONEDA: " AssociatedControlID="txtMoneda" runat="server"></asp:Label>
                                        &nbsp;
                                        <asp:Label ID="txtCapitalPagadoTipoMoneda" Text="" runat="server" CssClass="tb" Height="16px" Width="103px" ReadOnly="True"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
                            ...
                            <div id="Socios">
                                ...
                                <div id="OrganoGestor" class="RadGrid RadGrid_NoboxGrid">
                                    ...
                                    <div id="div1" runat="server">
                                        <h4 style="align-content: center; height: 5px;" align="center">DATOS SOCIOS/ACCIONISTAS</h4>
                                        <br />
                                        <table class="auto-style2" style="width: 100%; empty-cells: show;" cellspacing="0" align="center">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <%--<th class="rgHeader">REGISTRO MERCANTIL REGISTRO PÚBLICO</th>--%>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="sociosRep" runat="server">
                                                    <ItemTemplate>
                                                        <tr class="rgRow">
                                                            <td><span><%# Eval("PersonaPrimerNombre") + " " + Eval("PersonaSegundoNombre") + " " + Eval("PersonaPrimerApellido") + " " +  Eval("PersonaSegundoApellido") %></span></td>
                                                            <td><span><%# CamaraComercio.Website.ExtensionMethods.FormatRnc(""+Eval("Documento"))%></span></td>
                                                            <%--<td><span><%# CamaraComercio.Website.ExtensionMethods.FormatRnc(""+Eval("NumeroRM"))%></span></td>--%>
                                                            <td><span><%# Eval("DireccionCalle") + " " + Eval("DireccionNombreSector") + ", " + Eval("DireccionNombreCiudad") %></span></td>
                                                            <td><span><%# Eval("Nacionalidad") %></span></td>
                                                            <td><span><%# Eval("PersonaEstadoCivil") %></span></td>
                                                        </tr>
                                                    </ItemTemplate>
                                                </asp:Repeater>
                                            </tbody>
                                        ...
                                        <br />
                                        <asp:Label ID="lblTotalSocios" runat="server" Text="CANTIDAD TOTAL SOCIOS: " CssClass="tb"></asp:Label>
                                        &nbsp;
                                    <asp:Label ID="txtTotalSocios" runat="server" Text="" CssClass="tb"></asp:Label>
                                        <br />
                                        <asp:Label ID="Label1" runat="server" AssociatedControlID="txtTotalAcciones" Text="CANTIDAD TOTAL ACCIONES : "></asp:Label>
                                        &nbsp;
                                    ...
                                    <div id="div2" runat="server">
                                        <h4 style="align-content: center; height: 5px;" align="center">DATOS CONSEJO DE ADMINISTRACIÓN/ÓRGANO DE GESTIÓN</h4>
                                ...
                                <div id="entesRegTbl" runat="server" class="RadGrid RadGrid_NoboxGrid">
