<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/res/noboxForm.Master" CodeBehind="SociedadResponsabilidadLimitada.aspx.cs" Inherits="CamaraComercio.Website.Formularios.SociedadResponsabilidadLimitada" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="cont" class="container_24">
        <div class="grid_24">
                            ...
                            <div id="gestorData" class="RadGrid RadGrid_NoboxGrid">
                                <ul style="padding-left: 5px; padding-top: 5px">
                                    <%--<li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtSolicitante" Text="" style="text-transform:uppercase;" runat="server" ReadOnly="True" CssClass="tb over" Width="70%"></asp:Label>
                                        <br />
                                        <br />
                                    </li>--%>
                                    <%--<li>
                                    ...
                                    <li>
                                        ...
                                        &nbsp;
                                        <asp:Label ID="txtNombreCont" Text="" style="text-transform:uppercase;" runat="server" ReadOnly="True" CssClass="tb over" Width="70%"></asp:Label>
                                        <br />
                                        <br />
                                    </li>
                                    <li>
