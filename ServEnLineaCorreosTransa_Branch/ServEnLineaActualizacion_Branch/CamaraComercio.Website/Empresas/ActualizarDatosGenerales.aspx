                            ...
                            <fieldset class="form-fieldset">
                                <ul>
                                  ...
                                  <%--  <li>
                                        ...
                                        <telerik:RadTextBox ID="txtCorreoEmpresa" runat="server" CssClass="tb" Width="250px" EmptyMessage="Correo de Empresa" Skin="" />
                                    </li>
                                     <li>
                                        <asp:Label runat="server" AssociatedControlID="txtCorreoContacto">
                                        Correo de Contacto <span class="required"></span>
                                        </asp:Label>
                                        <telerik:RadTextBox ID="txtCorreoContacto" runat="server" CssClass="tb" Width="250px" EmptyMessage="Correo de Contacto" Skin="" />
                                    </li>
