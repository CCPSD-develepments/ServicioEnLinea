...
namespace CamaraComercio.DataAccess.CamaraWebsiteAccounts
{
	...
	public partial class AspnetApplication : ActiveRecord<AspnetApplication>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Applications", TableType.Table, DataService.GetInstance("WebsiteAccountsProvider"));
				...
				DataService.Providers["WebsiteAccountsProvider"].AddSchema("aspnet_Applications",schema);
			}
		}
		#endregion
		...
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetMembershipCollection().Where(AspnetMembership.Columns.ApplicationId, ApplicationId).Load();
		}
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetPathCollection AspnetPaths()
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetPathCollection().Where(AspnetPath.Columns.ApplicationId, ApplicationId).Load();
		}
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetRoleCollection AspnetRoles()
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetRoleCollection().Where(AspnetRole.Columns.ApplicationId, ApplicationId).Load();
		}
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetUserCollection AspnetUsers()
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetUserCollection().Where(AspnetUser.Columns.ApplicationId, ApplicationId).Load();
		}
		#endregion
