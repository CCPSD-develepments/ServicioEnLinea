...
{
	/// <summary>
	/// Strongly-typed collection for the Cargo class.
	/// </summary>
    [Serializable]
	public partial class CargoCollection : ActiveList<Cargo, CargoCollection>
	{	   
        ...
        /// </summary>
        /// <returns>CargoCollection</returns>
		public CargoCollection Filter()
        {
	...
	/// </summary>
	[Serializable]
	public partial class Cargo : ActiveRecord<Cargo>, IActiveRecord
	{
		...
		public Cargo(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Cargo(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Cargos", TableType.Table, DataService.GetInstance("OficinaVirtualProvider"));
				...
				DataService.Providers["OficinaVirtualProvider"].AddSchema("Cargos",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varCargoId,string varDescripcion,DateTime varFechaModificacion)
		{
			Cargo item = new Cargo();
