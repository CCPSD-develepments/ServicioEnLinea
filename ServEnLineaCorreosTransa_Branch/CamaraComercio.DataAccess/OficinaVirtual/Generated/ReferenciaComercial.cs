...
{
	/// <summary>
	/// Strongly-typed collection for the ReferenciaComercial class.
	/// </summary>
    [Serializable]
	public partial class ReferenciaComercialCollection : ActiveList<ReferenciaComercial, ReferenciaComercialCollection>
	{	   
		public ReferenciaComercialCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ReferenciaComercialCollection</returns>
		public ReferenciaComercialCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ReferenciaComercial o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class ReferenciaComercial : ActiveRecord<ReferenciaComercial>, IActiveRecord
	{
		...
		public ReferenciaComercial(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public ReferenciaComercial(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public ReferenciaComercial(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ReferenciasComerciales", TableType.Table, DataService.GetInstance("OficinaVirtualProvider"));
				...
				DataService.Providers["OficinaVirtualProvider"].AddSchema("ReferenciasComerciales",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a Registro ActiveRecord object related to this ReferenciaComercial
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(int varRegistroId,string varTipoReferencia,string varDescripcion,DateTime varFechaModificacion)
		{
		...
		/// </summary>
		public static void Update(int varReferenciaComercialId,int varRegistroId,string varTipoReferencia,string varDescripcion,DateTime varFechaModificacion)
		{
			ReferenciaComercial item = new ReferenciaComercial();
