...
{
	/// <summary>
	/// Strongly-typed collection for the TipoEnteRegulado class.
	/// </summary>
    [Serializable]
	public partial class TipoEnteReguladoCollection : ActiveList<TipoEnteRegulado, TipoEnteReguladoCollection>
	{	   
		public TipoEnteReguladoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TipoEnteReguladoCollection</returns>
		public TipoEnteReguladoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TipoEnteRegulado o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class TipoEnteRegulado : ActiveRecord<TipoEnteRegulado>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TipoEnteRegulado()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TipoEnteRegulado(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TipoEnteRegulado(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TipoEnteRegulado(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("TiposEnteRegulado", TableType.Table, DataService.GetInstance("OficinaVirtualProvider"));
				...
				DataService.Providers["OficinaVirtualProvider"].AddSchema("TiposEnteRegulado",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varTipoEnteReguladoId,string varDescripcion,DateTime varFechaModificacion)
		{
			TipoEnteRegulado item = new TipoEnteRegulado();
