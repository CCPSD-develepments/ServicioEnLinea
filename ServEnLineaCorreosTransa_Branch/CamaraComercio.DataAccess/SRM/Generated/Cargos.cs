...
{
	/// <summary>
	/// Strongly-typed collection for the Cargos class.
	/// </summary>
    [Serializable]
	public partial class CargosCollection : ActiveList<Cargos, CargosCollection>
	{	   
		public CargosCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>CargosCollection</returns>
		public CargosCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Cargos table.
	/// </summary>
	[Serializable]
	public partial class Cargos : ActiveRecord<Cargos>, IActiveRecord
	{
		...
		public Cargos(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Cargos(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Cargos", TableType.Table, DataService.GetInstance("SrmProvider"));
				...
				colvarCargoId.AutoIncrement = true;
				colvarCargoId.IsNullable = false;
				colvarCargoId.IsPrimaryKey = true;
				...
				DataService.Providers["SrmProvider"].AddSchema("Cargos",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varCargoId,string varDescripcion,DateTime varFechaModificacion,Guid varRowguid)
		{
			Cargos item = new Cargos();
