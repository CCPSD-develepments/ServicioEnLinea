...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewMovimientosTransaccionesByEntrega class.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByEntregaCollection : ReadOnlyList<ViewMovimientosTransaccionesByEntrega, ViewMovimientosTransaccionesByEntregaCollection>
    {        
        public ViewMovimientosTransaccionesByEntregaCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_MovimientosTransaccionesByEntrega view.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByEntrega : ReadOnlyRecord<ViewMovimientosTransaccionesByEntrega>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_MovimientosTransaccionesByEntrega", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_MovimientosTransaccionesByEntrega",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewMovimientosTransaccionesByEntrega()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewMovimientosTransaccionesByEntrega(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewMovimientosTransaccionesByEntrega(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewMovimientosTransaccionesByEntrega(string columnName, object columnValue)
        {
            SetSQLProps();
