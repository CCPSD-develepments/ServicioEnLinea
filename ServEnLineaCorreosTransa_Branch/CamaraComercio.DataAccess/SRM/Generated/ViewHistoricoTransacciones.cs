...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewHistoricoTransacciones class.
    /// </summary>
    [Serializable]
    public partial class ViewHistoricoTransaccionesCollection : ReadOnlyList<ViewHistoricoTransacciones, ViewHistoricoTransaccionesCollection>
    {        
        public ViewHistoricoTransaccionesCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_HistoricoTransacciones view.
    /// </summary>
    [Serializable]
    public partial class ViewHistoricoTransacciones : ReadOnlyRecord<ViewHistoricoTransacciones>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_HistoricoTransacciones", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_HistoricoTransacciones",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewHistoricoTransacciones()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewHistoricoTransacciones(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewHistoricoTransacciones(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewHistoricoTransacciones(string columnName, object columnValue)
        {
            SetSQLProps();
