...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewSociosRegistrosSocios class.
    /// </summary>
    [Serializable]
    public partial class ViewSociosRegistrosSociosCollection : ReadOnlyList<ViewSociosRegistrosSocios, ViewSociosRegistrosSociosCollection>
    {        
        public ViewSociosRegistrosSociosCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_SociosRegistrosSocios view.
    /// </summary>
    [Serializable]
    public partial class ViewSociosRegistrosSocios : ReadOnlyRecord<ViewSociosRegistrosSocios>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_SociosRegistrosSocios", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_SociosRegistrosSocios",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewSociosRegistrosSocios()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewSociosRegistrosSocios(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewSociosRegistrosSocios(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewSociosRegistrosSocios(string columnName, object columnValue)
        {
            SetSQLProps();
