...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewMovimientosTransaccionesByProblema class.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByProblemaCollection : ReadOnlyList<ViewMovimientosTransaccionesByProblema, ViewMovimientosTransaccionesByProblemaCollection>
    {        
        public ViewMovimientosTransaccionesByProblemaCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_MovimientosTransaccionesByProblema view.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByProblema : ReadOnlyRecord<ViewMovimientosTransaccionesByProblema>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_MovimientosTransaccionesByProblema", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_MovimientosTransaccionesByProblema",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewMovimientosTransaccionesByProblema()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewMovimientosTransaccionesByProblema(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewMovimientosTransaccionesByProblema(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewMovimientosTransaccionesByProblema(string columnName, object columnValue)
        {
            SetSQLProps();
