...
namespace CamaraComercio.DataAccess.CamaraWebsiteAccounts
{
	...
	public partial class AspnetUsersInRole : ActiveRecord<AspnetUsersInRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_UsersInRoles", TableType.Table, DataService.GetInstance("WebsiteAccountsProvider"));
				...
				DataService.Providers["WebsiteAccountsProvider"].AddSchema("aspnet_UsersInRoles",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetRole AspnetRole
		{
			get { return CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetRole.FetchByID(this.RoleId); }
