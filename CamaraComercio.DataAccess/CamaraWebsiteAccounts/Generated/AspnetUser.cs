...
namespace CamaraComercio.DataAccess.CamaraWebsiteAccounts
{
	...
	public partial class AspnetUser : ActiveRecord<AspnetUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Users", TableType.Table, DataService.GetInstance("WebsiteAccountsProvider"));
				...
				DataService.Providers["WebsiteAccountsProvider"].AddSchema("aspnet_Users",schema);
			}
		}
		#endregion
		...
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetMembershipCollection AspnetMembershipRecords()
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetMembershipCollection().Where(AspnetMembership.Columns.UserId, UserId).Load();
		}
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.UserId, UserId).Load();
		}
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetProfileCollection AspnetProfileRecords()
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetProfileCollection().Where(AspnetProfile.Columns.UserId, UserId).Load();
		}
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetUsersInRoleCollection AspnetUsersInRoles()
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.UserId, UserId).Load();
		}
		#endregion
		...
		/// 
		/// </summary>
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetApplication AspnetApplication
		{
			get { return CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetApplication.FetchByID(this.ApplicationId); }
		...
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetRoleCollection GetAspnetRoleCollection() { return AspnetUser.GetAspnetRoleCollection(this.UserId); }
		public static CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetRoleCollection GetAspnetRoleCollection(Guid varUserId)
		{
