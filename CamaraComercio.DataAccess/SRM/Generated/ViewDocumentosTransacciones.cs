...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewDocumentosTransacciones class.
    /// </summary>
    [Serializable]
    public partial class ViewDocumentosTransaccionesCollection : ReadOnlyList<ViewDocumentosTransacciones, ViewDocumentosTransaccionesCollection>
    {        
        public ViewDocumentosTransaccionesCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_DocumentosTransacciones view.
    /// </summary>
    [Serializable]
    public partial class ViewDocumentosTransacciones : ReadOnlyRecord<ViewDocumentosTransacciones>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_DocumentosTransacciones", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                colvarFechaTransaccion.ColumnName = "FechaTransaccion";
                ...
                colvarFechaTransaccion.IsNullable = false;
                ...
                colvarNumeroDocumento.MaxLength = 27;
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_DocumentosTransacciones",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewDocumentosTransacciones()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewDocumentosTransacciones(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewDocumentosTransacciones(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewDocumentosTransacciones(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public DateTime FechaTransaccion 
	    {
		    get
		    {
			    return GetColumnValue<DateTime>("FechaTransaccion");
		    }
            set 
		    {
			    SetColumnValue("FechaTransaccion", value);
            }
        }
