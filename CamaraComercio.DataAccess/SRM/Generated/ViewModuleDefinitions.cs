...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewModuleDefinitions class.
    /// </summary>
    [Serializable]
    public partial class ViewModuleDefinitionsCollection : ReadOnlyList<ViewModuleDefinitions, ViewModuleDefinitionsCollection>
    {        
        public ViewModuleDefinitionsCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_ModuleDefinitions view.
    /// </summary>
    [Serializable]
    public partial class ViewModuleDefinitions : ReadOnlyRecord<ViewModuleDefinitions>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_ModuleDefinitions", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                colvarModuloId.IsNullable = true;
                ...
                colvarNombreEtiqueta.IsNullable = true;
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_ModuleDefinitions",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewModuleDefinitions()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewModuleDefinitions(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewModuleDefinitions(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewModuleDefinitions(string columnName, object columnValue)
        {
            SetSQLProps();
