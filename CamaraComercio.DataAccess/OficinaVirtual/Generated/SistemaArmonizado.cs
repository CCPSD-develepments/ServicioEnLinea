...
{
	/// <summary>
	/// Strongly-typed collection for the SistemaArmonizado class.
	/// </summary>
    [Serializable]
	public partial class SistemaArmonizadoCollection : ActiveList<SistemaArmonizado, SistemaArmonizadoCollection>
	{	   
		public SistemaArmonizadoCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>SistemaArmonizadoCollection</returns>
		public SistemaArmonizadoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                SistemaArmonizado o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class SistemaArmonizado : ActiveRecord<SistemaArmonizado>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public SistemaArmonizado()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public SistemaArmonizado(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public SistemaArmonizado(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public SistemaArmonizado(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("SistemasArmonizados", TableType.Table, DataService.GetInstance("OficinaVirtualProvider"));
				...
				DataService.Providers["OficinaVirtualProvider"].AddSchema("SistemasArmonizados",schema);
			}
		}
		#endregion
		...
		{
			return new CamaraComercio.DataAccess.OficinaVirtual.ProductoCollection().Where(Producto.Columns.SistemaArmonizadoId, SistemaArmonizadoId).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varSistemaArmonizadoId,string varDescripcion,DateTime varFechaModificacion)
		{
		...
		/// </summary>
		public static void Update(string varSistemaArmonizadoId,string varDescripcion,DateTime varFechaModificacion)
		{
			SistemaArmonizado item = new SistemaArmonizado();
