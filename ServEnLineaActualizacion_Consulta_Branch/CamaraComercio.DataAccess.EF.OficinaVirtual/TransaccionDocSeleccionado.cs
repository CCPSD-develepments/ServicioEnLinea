...
{
    [Serializable]
    public partial class TransaccionDocSeleccionado
    {
        ...
        {
            if (previousValue != null && previousValue.TransaccionDocSeleccionado.Contains(this))
            {
                previousValue.TransaccionDocSeleccionado.Remove(this);
            }
    
            if (Transacciones != null)
            {
                if (!Transacciones.TransaccionDocSeleccionado.Contains(this))
                {
                    Transacciones.TransaccionDocSeleccionado.Add(this);
                }
