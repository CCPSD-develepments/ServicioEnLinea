...
{
	/// <summary>
	/// Strongly-typed collection for the Pais class.
	/// </summary>
    [Serializable]
	public partial class PaisCollection : ActiveList<Pais, PaisCollection>
	{	   
        ...
        /// </summary>
        /// <returns>PaisCollection</returns>
		public PaisCollection Filter()
        {
	...
	/// </summary>
	[Serializable]
	public partial class Pais : ActiveRecord<Pais>, IActiveRecord
	{
		...
		public Pais(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Pais(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Paises", TableType.Table, DataService.GetInstance("OficinaVirtualProvider"));
				...
				DataService.Providers["OficinaVirtualProvider"].AddSchema("Paises",schema);
			}
		}
		#endregion
		...
		public CamaraComercio.DataAccess.OficinaVirtual.CiudadCollection CiudadRecords()
		{
			return new CamaraComercio.DataAccess.OficinaVirtual.CiudadCollection().Where(Ciudad.Columns.PaisId, PaisId).Load();
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varNombre,string varDescripcion,int? varOrden,DateTime varFechaModificacion)
		{
			Pais item = new Pais();
		...
		/// </summary>
		public static void Update(int varPaisId,string varNombre,string varDescripcion,int? varOrden,DateTime varFechaModificacion)
		{
			Pais item = new Pais();
