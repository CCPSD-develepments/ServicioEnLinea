...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewMovimientosTransaccionesByAnalizadoProblema class.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByAnalizadoProblemaCollection : ReadOnlyList<ViewMovimientosTransaccionesByAnalizadoProblema, ViewMovimientosTransaccionesByAnalizadoProblemaCollection>
    {        
        public ViewMovimientosTransaccionesByAnalizadoProblemaCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_MovimientosTransaccionesByAnalizadoProblema view.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByAnalizadoProblema : ReadOnlyRecord<ViewMovimientosTransaccionesByAnalizadoProblema>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_MovimientosTransaccionesByAnalizadoProblema", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_MovimientosTransaccionesByAnalizadoProblema",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewMovimientosTransaccionesByAnalizadoProblema()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewMovimientosTransaccionesByAnalizadoProblema(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewMovimientosTransaccionesByAnalizadoProblema(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewMovimientosTransaccionesByAnalizadoProblema(string columnName, object columnValue)
        {
            SetSQLProps();
