...
{
	/// <summary>
	/// Strongly-typed collection for the Profesiones class.
	/// </summary>
    [Serializable]
	public partial class ProfesionesCollection : ActiveList<Profesiones, ProfesionesCollection>
	{	   
		public ProfesionesCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ProfesionesCollection</returns>
		public ProfesionesCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                Profesiones o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class Profesiones : ActiveRecord<Profesiones>, IActiveRecord
	{
		...
		public Profesiones(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public Profesiones(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public Profesiones(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Profesiones", TableType.Table, DataService.GetInstance("SrmProvider"));
				...
				DataService.Providers["SrmProvider"].AddSchema("Profesiones",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varProfesionId,string varDescripcion,DateTime varFechaModificacion,Guid varRowguid)
		{
			Profesiones item = new Profesiones();
