...
namespace CamaraComercio.DataAccess.EF.SRM
{
    ...
    public static string DireccionOneId = @"DireccionOneId";
    public static string DireccionOne = @"DireccionOne";
    public static string DireccionOneValidada = @"DireccionOneValidada";
        ...
        public virtual Nullable<int> DireccionOneId
        {
            get;
            set;
        }
    
        public virtual string DireccionOne
        {
            get;
            set;
        }
    
        public virtual Nullable<bool> DireccionOneValidada
        {
            get;
            set;
        }
