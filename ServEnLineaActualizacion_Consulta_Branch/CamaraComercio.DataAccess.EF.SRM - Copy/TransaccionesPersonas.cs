...
{
    public partial class TransaccionesPersonas
    {
    ...
    public static string FechaModificacion = @"FechaModificacion";
        ...
        {
            if (previousValue != null && ReferenceEquals(previousValue.TransaccionesPersonas, this))
            {
                previousValue.TransaccionesPersonas = null;
            }
    
            if (Transacciones != null)
            {
                Transacciones.TransaccionesPersonas = this;
