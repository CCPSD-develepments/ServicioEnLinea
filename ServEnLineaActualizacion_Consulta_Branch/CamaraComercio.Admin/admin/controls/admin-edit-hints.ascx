<%@ Control Language="C#" AutoEventWireup="true" Inherits="admin_controls_admin_edit_hints" Codebehind="admin-edit-hints.ascx.cs" %>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetAdminHints" TypeName="admin_HintsTableAdapter" UpdateMethod="Update" OnSelected="ObjectDataSource1_Selected">
    <DeleteParameters>
