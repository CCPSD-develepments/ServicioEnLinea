...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'RegDup.Page_Load(object, EventArgs)'
        {
            ...
            Session["DocumentosSeleccionados"] = null;
             ...
             Response.Redirect("~/Empresas/RevisionDocumentos.aspx" + DefaultQueryString); // bk .2021-11-04:

            //2021-11-04:
            //if (servicioId == 401)
            //{
            //    var rpath = DefaultQueryString;
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'RegDup.btnConfirmar_Click(object, EventArgs)'
        {
            ...
            Session["DocumentosSeleccionados"] = null;
             ...
             Response.Redirect("~/Empresas/RevisionDocumentos.aspx" + DefaultQueryString); //2021-11-04:

            //2021-11-04:
            //if (servicioId == 401)
            //{
            //    var rpath = DefaultQueryString + "&nservId=" + servicioId;
            //    Response.Redirect("/Empresas/DatoGenerales.aspx" + rpath);
            //}
