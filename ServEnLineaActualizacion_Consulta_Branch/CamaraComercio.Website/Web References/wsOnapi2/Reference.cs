...
namespace CamaraComercio.Website.wsOnapi2 {
    using System;
    ...
    public partial class ServicioCC : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public ServicioCC() {
            this.Url = global::CamaraComercio.Website.Properties.Settings.Default.CamaraComercio_Website_wsOnapi2_ServicioCC;
        ...
        public ResultadoBusquedaNombre[] BuscarNombresComerciales(string texto, string user, string pwd) {
        ...
        /// <remarks/>
        public void BuscarNombresComercialesAsync(string texto, string user, string pwd) {
            this.BuscarNombresComercialesAsync(texto, user, pwd, null);
        }
        
        /// <remarks/>
        public void BuscarNombresComercialesAsync(string texto, string user, string pwd, object userState) {
            ...
            this.InvokeAsync("BuscarNombresComerciales", new object[] {
                        texto,
                        user,
                        pwd}, this.BuscarNombresComercialesOperationCompleted, userState);
        }
        ...
        public ResultadoBusquedaNombre BuscarNombrePorNumero(int numero, string user, string pwd) {
        ...
        /// <remarks/>
        public void BuscarNombrePorNumeroAsync(int numero, string user, string pwd) {
            this.BuscarNombrePorNumeroAsync(numero, user, pwd, null);
        }
        
        /// <remarks/>
        public void BuscarNombrePorNumeroAsync(int numero, string user, string pwd, object userState) {
            ...
            this.InvokeAsync("BuscarNombrePorNumero", new object[] {
                        numero,
                        user,
                        pwd}, this.BuscarNombrePorNumeroOperationCompleted, userState);
        }
