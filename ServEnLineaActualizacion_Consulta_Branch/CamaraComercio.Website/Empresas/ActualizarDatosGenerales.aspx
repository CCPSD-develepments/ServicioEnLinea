        ...
        <div class="grid_24">
            <div class="datos_form">
                ...
                <br />
                                ...
                                <h3>Datos de Contacto de la solicitud</h3>
                                <ul>                                    

                                    <asp:Panel ID="pnlCorreoContacto" runat="server">
                                  ...
                                  <asp:Label runat="server" AssociatedControlID="txtCorreoContacto">
                                    ...
                                    <li>
                                        ...
                                        <telerik:RadMaskedTextBox ID="txtTelefonoOficina" runat="server" CssClass="tb" 
                                            EmptyMessage="Teléfono Oficina" Skin="" EmptyMessageStyle-ForeColor="#cccccc" Mask="(###) ###-####" onchange="SetDefault();" onpaste="this.onchange();" />
