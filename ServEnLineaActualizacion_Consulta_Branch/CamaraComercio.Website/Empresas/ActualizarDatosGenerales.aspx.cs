...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'ActualizarDatosGenerales.Page_Load(object, EventArgs)'
        {
            ...
            if (nSolicitud > 0 && (Transaccion != null && Transaccion.TransaccionId > 0))
            {
            ...
            //2021-09-08: 
            var comentario = Helper.mMensajesDatosGenerales;
        ...
        private OFV.Transacciones UpdateTransaction(long transId, int? modeloId = null)
        {
            ...
            transaccion.RNCSolicitante = (transaccion.EstatusTransId == 15) ? transaccion.RNCSolicitante : ofvSociedad.Rnc;
