<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/res/noboxForm.Master" CodeBehind="SociedadEIRL.aspx.cs" Inherits="CamaraComercio.Website.Formularios.SociedadEIRL" %>
                        ...
                        <fieldset class="form-fieldset">
                            ...
                            <div id="sociedadData" class="RadGrid RadGrid_NoboxGrid">
                                ...
                                <ul style="padding-left: 5px; padding-top: 5px">
                                    ...
                                    <li>
                                        <br />
                                        <h5 style="align-content: center; height: 5px; color:black">CAPITAL APORTADO</h5>
                                        <br />
                                    </li>
                                    <li>
                            ...
                            <div id="Socios">
                                ...
                                <div id="OrganoGestor" class="RadGrid RadGrid_NoboxGrid">
                                    <%--  --%>
                                    <div id="propietarioDiv" runat="server">
                                        <h4 style="align-content: center; height: 5px;" align="center">DATOS PROPIETARIO</h4>
                                        <br />
