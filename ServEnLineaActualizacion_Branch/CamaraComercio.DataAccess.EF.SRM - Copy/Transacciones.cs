...
namespace CamaraComercio.DataAccess.EF.SRM
{
    ...
    public static string NotificarRetiroEstatus = @"NotificarRetiroEstatus";
    public static string NotificacionRetiroFecha = @"NotificacionRetiroFecha";
    public static string AceptaRetiroFecha = @"AceptaRetiroFecha";
    public static string NoTurnoClienteEntrada = @"NoTurnoClienteEntrada";
    public static string NoTurnoClienteRetiro = @"NoTurnoClienteRetiro";
    public static string FechaRetiroDocumento = @"FechaRetiroDocumento";
    public static string RegistroId = @"RegistroId";
    public static string VieneAnalisis = @"VieneAnalisis";
    public static string VieneDigitalizacion = @"VieneDigitalizacion";
    public static string CorreoEmpresa = @"CorreoEmpresa";
    public static string TransaccionReferenciada = @"TransaccionReferenciada";
    public static string bAutorizarCampos = @"bAutorizarCampos";
    public static string Color = @"Color";
    public static string TransaccionCancilleria = @"TransaccionCancilleria";
    public static string bRenovado = @"bRenovado";
    public static string Dynamics365CustomerAccount = @"Dynamics365CustomerAccount";
        ...
        public virtual Nullable<int> NotificarRetiroEstatus
        {
            get;
            set;
        }
    
        public virtual Nullable<System.DateTime> NotificacionRetiroFecha
        {
            get;
            set;
        }
    
        public virtual Nullable<System.DateTime> AceptaRetiroFecha
        {
            get;
            set;
        }
    
        public virtual string NoTurnoClienteEntrada
        {
            get;
            set;
        }
    
        public virtual string NoTurnoClienteRetiro
        {
            get;
            set;
        }
    
        public virtual Nullable<System.DateTime> FechaRetiroDocumento
        {
            get;
            set;
        }
        ...
        public virtual Nullable<bool> VieneAnalisis
        {
            get;
            set;
        }
    
        public virtual Nullable<bool> VieneDigitalizacion
        {
            get;
            set;
        }
        ...
        public virtual Nullable<int> TransaccionReferenciada
        {
            get;
            set;
        }
    
        public virtual Nullable<bool> bAutorizarCampos
        {
            get;
            set;
        }
        ...
        public virtual Nullable<bool> TransaccionCancilleria
        {
            get;
            set;
        }
    
        public virtual Nullable<bool> bRenovado
        {
            get;
            set;
        }
    
        public virtual string Dynamics365CustomerAccount
        {
            get;
            set;
        }
