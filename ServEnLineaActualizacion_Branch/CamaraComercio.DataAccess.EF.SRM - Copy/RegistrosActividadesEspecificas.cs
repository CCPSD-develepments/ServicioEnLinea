...
{
    public partial class RegistrosActividadesEspecificas
    {
    ...
    public static string ActividadEspecificaDescripcion = @"ActividadEspecificaDescripcion";
        ...
        public virtual int TipoActividadEspecificaId
        {
            get;
            set;
        }
        ...
        public virtual string ActividadEspecificaDescripcion
        {
            get;
            set;
        }
        ...
        {
            if (previousValue != null && previousValue.RegistrosActividadesEspecificas.Contains(this))
            {
                previousValue.RegistrosActividadesEspecificas.Remove(this);
            }
    
            if (Registros != null)
            {
                if (!Registros.RegistrosActividadesEspecificas.Contains(this))
                {
                    Registros.RegistrosActividadesEspecificas.Add(this);
                }
