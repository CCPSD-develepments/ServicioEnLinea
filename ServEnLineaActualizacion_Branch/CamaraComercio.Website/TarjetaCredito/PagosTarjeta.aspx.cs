...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'PagosTarjeta.Page_Load(object, EventArgs)'
        {
            ...
            if (CamaraId == "")
            {
                ...
                trSDQ_Problemas = context.Transacciones.FirstOrDefault(x => x.TransaccionIdAnterior == this.TransaccionId && x.DesdeOfv)?.VieneProblemas == true ? true : false;
            }
            else
            {
...
//#if !DEBUG
                ...
                if (trSDQ_Problemas)
                {
                    ...
                    if (tr != null)
                    {
                        ...
                        var pRnc = !string.IsNullOrEmpty(tr.RNCSolicitante) ? tr.RNCSolicitante : "";

                        txtRnc.Text = pRnc.RemoverFormato();
                        txtRnc.Enabled = false;                    
                        this.txtRnc.BackColor = System.Drawing.Color.LightGray;

                        txtNombre.Text = tr.Solicitante;
                        txtNombre.Enabled = false;
                        this.txtNombre.BackColor = System.Drawing.Color.LightGray;

                        ddlTipoComprobantes.SelectedValue = tr.TipoComprobanteId.Value.ToString();
                        ddlTipoComprobantes.Enabled = false;
                        this.ddlTipoComprobantes.BackColor = System.Drawing.Color.LightGray;
                    }
