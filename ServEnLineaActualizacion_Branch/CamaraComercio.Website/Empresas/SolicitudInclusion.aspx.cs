        ...
        private void Update(long transId)
        {
          ...
          //  var registroSRM = SrmDbContext.Registros.FirstOrDefault(d => d.RegistroId == this.RegistroId);
            ...
            using (DbTransaction tnx = repEmpresa.BeginTransaction())
            {
                ...
                //2021-10-04:
                transSolicitudInclusion.CorreoContacto = _CorreoContacto;
                transSolicitudInclusion.CorreoEmpresa = (registro != null) ? registro.Direcciones.Email : "";
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member 'SolicitudInclusion.btnSolicitar_Click(object, EventArgs)'
        {
            ...
            using (DbTransaction tnx = repEmpresa.BeginTransaction())
            {
                ...
                var transSolicitudInclusion = new OFV.Transacciones()
                {
                    ...
                    CorreoEmpresa = (registro != null) ? registro.Direcciones.Email : ""
