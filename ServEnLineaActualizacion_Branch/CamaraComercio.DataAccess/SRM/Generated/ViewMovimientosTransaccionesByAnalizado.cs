...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ViewMovimientosTransaccionesByAnalizado class.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByAnalizadoCollection : ReadOnlyList<ViewMovimientosTransaccionesByAnalizado, ViewMovimientosTransaccionesByAnalizadoCollection>
    {        
        public ViewMovimientosTransaccionesByAnalizadoCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the cvw_MovimientosTransaccionesByAnalizado view.
    /// </summary>
    [Serializable]
    public partial class ViewMovimientosTransaccionesByAnalizado : ReadOnlyRecord<ViewMovimientosTransaccionesByAnalizado>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("cvw_MovimientosTransaccionesByAnalizado", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                DataService.Providers["SrmProvider"].AddSchema("cvw_MovimientosTransaccionesByAnalizado",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public ViewMovimientosTransaccionesByAnalizado()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public ViewMovimientosTransaccionesByAnalizado(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ViewMovimientosTransaccionesByAnalizado(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ViewMovimientosTransaccionesByAnalizado(string columnName, object columnValue)
        {
            SetSQLProps();
