...
{
	/// <summary>
	/// Strongly-typed collection for the RegistrosSociosSociedades class.
	/// </summary>
    [Serializable]
	public partial class RegistrosSociosSociedadesCollection : ActiveList<RegistrosSociosSociedades, RegistrosSociosSociedadesCollection>
	{	   
		public RegistrosSociosSociedadesCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>RegistrosSociosSociedadesCollection</returns>
		public RegistrosSociosSociedadesCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                RegistrosSociosSociedades o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the RegistrosSociosSociedades table.
	/// </summary>
	[Serializable]
	public partial class RegistrosSociosSociedades : ActiveRecord<RegistrosSociosSociedades>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public RegistrosSociosSociedades()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public RegistrosSociosSociedades(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public RegistrosSociosSociedades(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public RegistrosSociosSociedades(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RegistrosSociosSociedades", TableType.Table, DataService.GetInstance("SrmProvider"));
				...
				DataService.Providers["SrmProvider"].AddSchema("RegistrosSociosSociedades",schema);
			}
		}
		#endregion
		...
		/// <summary>
		/// Returns a Direcciones ActiveRecord object related to this RegistrosSociosSociedades
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Registros ActiveRecord object related to this RegistrosSociosSociedades
		/// 
		/// </summary>
		...
		/// <summary>
		/// Returns a Sociedades ActiveRecord object related to this RegistrosSociosSociedades
		/// 
		/// </summary>
		...
		/// </summary>
		public static void Insert(int varRegistroId,int varSociedadId,string varTipoRelacion,int varDireccionId,int varRepresentanteId,int varOrden,DateTime varFechaModificacion,Guid varRowguid)
		{
		...
		/// </summary>
		public static void Update(int varId,int varRegistroId,int varSociedadId,string varTipoRelacion,int varDireccionId,int varRepresentanteId,int varOrden,DateTime varFechaModificacion,Guid varRowguid)
		{
			RegistrosSociosSociedades item = new RegistrosSociosSociedades();
