...
namespace CamaraComercio.DataAccess.SRM{
    /// <summary>
    /// Strongly-typed collection for the ConsultaActividades class.
    /// </summary>
    [Serializable]
    public partial class ConsultaActividadesCollection : ReadOnlyList<ConsultaActividades, ConsultaActividadesCollection>
    {        
        public ConsultaActividadesCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the ConsultaActividades view.
    /// </summary>
    [Serializable]
    public partial class ConsultaActividades : ReadOnlyRecord<ConsultaActividades>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("ConsultaActividades", TableType.View, DataService.GetInstance("SrmProvider"));
                ...
                colvarActividad.IsNullable = false;
                ...
                DataService.Providers["SrmProvider"].AddSchema("ConsultaActividades",schema);
            }
        }
        #endregion
        ...
        public ConsultaActividades(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public ConsultaActividades(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public ConsultaActividades(string columnName, object columnValue)
        {
            SetSQLProps();
