...
namespace CamaraComercio.DataAccess.CamaraWebsiteAccounts
{
	...
	public partial class AspnetMembership : ActiveRecord<AspnetMembership>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Membership", TableType.Table, DataService.GetInstance("WebsiteAccountsProvider"));
				...
				DataService.Providers["WebsiteAccountsProvider"].AddSchema("aspnet_Membership",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetUser AspnetUser
		{
			get { return CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetUser.FetchByID(this.UserId); }
