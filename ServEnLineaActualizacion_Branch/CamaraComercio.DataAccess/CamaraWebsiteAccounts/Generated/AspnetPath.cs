...
namespace CamaraComercio.DataAccess.CamaraWebsiteAccounts
{
	...
	public partial class AspnetPath : ActiveRecord<AspnetPath>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Paths", TableType.Table, DataService.GetInstance("WebsiteAccountsProvider"));
				...
				DataService.Providers["WebsiteAccountsProvider"].AddSchema("aspnet_Paths",schema);
			}
		}
		#endregion
		...
		public CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetPersonalizationAllUserCollection AspnetPersonalizationAllUsers()
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetPersonalizationAllUserCollection().Where(AspnetPersonalizationAllUser.Columns.PathId, PathId).Load();
		}
		...
		{
			return new CamaraComercio.DataAccess.CamaraWebsiteAccounts.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.PathId, PathId).Load();
		}
		#endregion
