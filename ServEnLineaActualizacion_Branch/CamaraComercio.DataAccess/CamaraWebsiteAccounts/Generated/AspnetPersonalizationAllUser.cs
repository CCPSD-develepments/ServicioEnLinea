...
namespace CamaraComercio.DataAccess.CamaraWebsiteAccounts
{
	...
	public partial class AspnetPersonalizationAllUser : ActiveRecord<AspnetPersonalizationAllUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_PersonalizationAllUsers", TableType.Table, DataService.GetInstance("WebsiteAccountsProvider"));
				...
				DataService.Providers["WebsiteAccountsProvider"].AddSchema("aspnet_PersonalizationAllUsers",schema);
			}
		}
		#endregion
