...
public partial class controls_login_with_captcha : System.Web.UI.UserControl
{
    ...
    protected void Login1_Authenticate(object sender, AuthenticateEventArgs e)
    {
        ...
        {
            // CAPTCHA invalid
            lblFailureText.Text = "Código de seguridad incorrecto o faltante.";
        ...
        else
        {
            ...
            {
                e.Authenticated = false;
                lblFailureText.Text = "Usuario y contraseña no coinciden.";
                lblFailureText.Visible = true;
            }
        }
    ...
    protected void Login1_LoginError(object sender, EventArgs e)
    {
        ...
        if (usrInfo.IsLockedOut)
        {
            ...
            lblFailureText.Text = "Su cuenta ha sido bloqueada por realizar demasiados intentos, por favor espere " + passwordAttemptLockoutDuration + " minutes e intente otra vez.";
            lblFailureText.Visible = true;
        }
        ...
        lblFailureText.Text = "Su cuenta no ha sido aprobada aun.";
        lblFailureText.Visible = true;
    }
    ...
    protected void Login1_LoggingIn(object sender, LoginCancelEventArgs e)
    {
        ...
        lblFailureText.Text = usrInfo + ", por nuestra politica, tu cuenta ha expirado. Se ha enviado un email con sus nuevas credenciales.";
        lblFailureText.Visible = true;
