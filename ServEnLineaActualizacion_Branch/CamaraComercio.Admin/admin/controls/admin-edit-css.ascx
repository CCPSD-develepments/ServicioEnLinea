<%@ Control Language="C#" AutoEventWireup="true" Inherits="admin_controls_admin_edit_css" Codebehind="admin-edit-css.ascx.cs" %>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetAdminCss" TypeName="site_ThemeCssTableAdapter" UpdateMethod="Update" OnSelected="ObjectDataSource1_Selected">
    <DeleteParameters>
